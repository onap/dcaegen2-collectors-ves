...
repository and mapping file for schemas. After spec creation script automatically adds ConfigMap to Kubernetes basing 
on generated spec.
...
repository size and number of schemas. All YAML files from selected directory in repository will be considered as schemas and 
...
- **GIT_REPO_URL** - URL from remote Git repository which lets to clone repository via HTTPS.  
