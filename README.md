...
Configuration stored in Consul have bigger priority and always will override local configuration. All configuration modification should be done using Consul section dmap / ves-collector. 
