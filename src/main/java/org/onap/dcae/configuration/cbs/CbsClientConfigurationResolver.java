...
class CbsClientConfigurationResolver {
    ...
    private static final String ENV_CONFIG_PROTOCOL = "http";
    ...
    CbsClientConfiguration resolve() {
        Optional<CbsClientConfiguration> cbsClientConfiguration = readConfigurationFromEnvrionment();
        return cbsClientConfiguration.orElseGet(this::getFallbackConfiguration);
    }
    ...
    private Optional<CbsClientConfiguration> readConfigurationFromEnvrionment() {
        ...
        return Optional.of(createCbsClientConfiguration(ENV_CONFIG_PROTOCOL, hostname, appName, Integer.valueOf(port)));
    }
    ...
    private ImmutableCbsClientConfiguration createCbsClientConfiguration(String protocol, String hostname,
        String appName, Integer integer) {
