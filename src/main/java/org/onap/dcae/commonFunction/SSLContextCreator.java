...
public class SSLContextCreator {
    ...
    private boolean hasTslClientAuthorization = false;
    ...
    public SSLContextCreator withTlsClientAuthorization(final Path trustStoreFile, final String password) {
        hasTslClientAuthorization = true;
    ...
    public Ssl build() {
        ...
        if (hasTslClientAuthorization) {
            String trustStore = trustStoreFile.toAbsolutePath().toString();
