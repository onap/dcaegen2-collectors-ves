...
public class DmaapRequestConfiguration {
    ...
    public static MessageRouterPublishRequest createPublishRequest(Option<PublisherConfig> publisherConfig, Long timeout) {
    ...
    public static MessageRouterPublishRequest createPublishRequest(Option<PublisherConfig> publisherConfig) {
    ...
    public static MessageRouterPublisherConfig retryConfiguration() {
