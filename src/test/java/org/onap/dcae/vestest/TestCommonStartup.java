...
public class TestCommonStartup {
    ...
    @Test
    public void shouldParseCLIArgumentsAndLoadDefaultCollectorProperties() throws loadException {
        // given
        String args[] = {"-a", "aa"};
        Map<String, String> argMap = NsaCommandLineUtil.processCmdLine(args, true);
        String config = NsaCommandLineUtil.getSetting(argMap, "c", "collector.properties");
        URL settingStream = DrumlinServlet.findStream(config, CommonStartup.class);
        ...
        assertEquals(settings.getString("collector.schema.checkflag", "default"), "1");
    }
    ...
    @Test
    public void shouldParseStreamIdToStreamHashMapping() {
        // given
        ...
        // when
        Map<String, String[]> streamHashMapping = eventProcessor
            .parseStreamIdToStreamHashMapping(CommonStartup.streamid);
