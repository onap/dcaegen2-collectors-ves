...
public class EventSenderTest {
  ...
  public void shouldNotSendEventWhenStreamIdIsNotDefined() throws IOException {
    ...
    List<VesEvent> eventToSend = createEventToSend("/collectorVesEvents/ves7_valid_event.json");
  ...
  public void shouldSendStdDefinedEventAtStreamAssignedToEventDomain() throws IOException {
    ...
    List<VesEvent> eventToSend = createEventToSend("/collectorVesEvents/ves_stdnDefined_valid.json");
