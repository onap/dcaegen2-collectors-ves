...
class PublisherTestMockServer {
    ...
    void publisher_shouldHandleClientTimeoutErrorWhenTimeoutDefined() {
        ...
        //when
        final Flux<MessageRouterPublishResponse> result = publisher.publishEvent(events, createPublishRequest(createPublishConfig(), timeoutSec));
    ...
    void publishEvent_shouldSuccessfullyPublishSingleMessage() {
        ...
        //when
        final Flux<MessageRouterPublishResponse> result = publisher.publishEvent(List.of(simpleEvent), createPublishConfig());
