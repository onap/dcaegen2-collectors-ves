...
public class ConfigLoaderTest {
    ...
    private void mockVesDmaapConfigInCbs(JSONObject dmaapConf) {
        ...
        when(cbsClientMock.getAppConfig()).thenReturn(Option.of(jsonObject));
    }

    private void mockVesConfigInCbs(HashMap<String, String> properties) {
        when(cbsClientMock.getAppConfig()).thenReturn(Option.of(prepareConfigurationJson(properties)));
    }
