...
public class DMaaPPublishersCacheTest {
    ...
    public void shouldCloseCambriaPublisherOnCacheInvalidate() throws IOException, InterruptedException {
        ...
        DMaaPPublishersCache dMaaPPublishersCache = new DMaaPPublishersCache(cacheLoaderMock, new OnPublisherRemovalListener(),
                                                                             dMaaPConfigs);
    ...
    public void shouldCloseOnlyChangedPublishers() throws IOException, InterruptedException {
        ...
        Map<String, PublisherConfig> oldConfig = Map(firstDomain, new PublisherConfig(List("destination1"), "topic1"),
                                                     secondDomain, new PublisherConfig(List("destination2"), "topic2", "user", "pass"));
        ...
        DMaaPPublishersCache dMaaPPublishersCache = new DMaaPPublishersCache(cacheLoaderMock, new OnPublisherRemovalListener(), oldConfig);
