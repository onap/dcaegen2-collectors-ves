...
public class EventValidatorTest {
    ...
    public void shouldReturnEmptyOptionalOnValidNewJsonObjectSchemaV7() {
        //given
        event = new JSONObject(FileReader.readFileAsString("src/test/resources/ves7_valid.json"));
    ...
    public void shouldReturnEmptyOptionalOnValidOldJsonObjectSchemaV7() {
        //given
        event = new JSONObject(FileReader.readFileAsString("src/test/resources/ves7_newValid.json"));
    ...
    public void shouldReturnEmptyOptionalOnInvalidJsonObjectSchemaV7() {
        //given
        event = new JSONObject(FileReader.readFileAsString("src/test/resources/ves7_invalid.json"));
