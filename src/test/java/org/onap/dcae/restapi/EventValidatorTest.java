...
public class EventValidatorTest {
    ...
    public static final String SCHEMA_VERSION = "dummy";
    ...
    public void shouldReturnEmptyOptionalOnJsonSchemaValidationDisabled() {
        ...
        //when
        Optional<ResponseEntity<String>> valid = sut.validate(jsonObject, TYPE, SCHEMA_VERSION);
    ...
    public void shouldReturnInvalidJsonErrorOnWrongType() {
        //when
        Optional<ResponseEntity<String>> valid = sut.validate(jsonObject, "wrongType", SCHEMA_VERSION);
