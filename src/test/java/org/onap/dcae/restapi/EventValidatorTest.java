...
public class EventValidatorTest {
    ...
    @Test
    public void shouldReturnNoErrorsWhenValidOldEvent() {
        //given
        event = new JSONObject(FileReader.readFileAsString("src/test/resources/ves7_validOldEvent.json"));
    ...
    @Test
    public void shouldReturnNoErrorsWhenValidEventWithStndDefinedFields() {
        //given
    ...
    @Test
    public void shouldReturnSchemaValidationFaildWhenInvalidEvent() {
        //given
        event = new JSONObject(FileReader.readFileAsString("src/test/resources/ves7_invalidOldEvent.json"));
