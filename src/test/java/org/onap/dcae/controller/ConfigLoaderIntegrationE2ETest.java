...
public class ConfigLoaderIntegrationE2ETest extends WiremockBasedTest {
    ...
    public void testSuccessfulE2EFlow() {
        ...
        ConfigLoader configLoader = new ConfigLoader(eventPublisherMock::reconfigure, configFilesFacade, ConfigSource::getAppConfig, () -> wiremockBasedEnvProps(), properties);
